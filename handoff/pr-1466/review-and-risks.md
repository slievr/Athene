...
Each of these has at least one test. **If you change `migrate-storage/`, run** `pnpm --filter @slievr/core test` **and read the failures carefully** — they're load-bearing.
