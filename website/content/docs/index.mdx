---
title: Introduction
description: Learn what Athene does, when to use it, and where to start.
---

import { Callout } from "fumadocs-ui/components/callout";

Athene (**AO**) runs AI coding agents in isolated git worktrees and keeps track of the work until it becomes a pull request.
...
```text
issue -> athene spawn -> worktree + agent -> pull request -> CI/review loop -> merge -> cleanup
```
