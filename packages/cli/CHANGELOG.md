...
- Updated dependencies [80ef5dc]
  - @made-by-moonlight/athene-web@0.12.0
  - @made-by-moonlight/athene-core@0.12.0
  - @made-by-moonlight/athene-plugin-agent-aider@0.12.0
  ...
  - @made-by-moonlight/athene-plugin-notifier-composio@0.12.0
  - @made-by-moonlight/athene-plugin-notifier-dashboard@0.12.0
  - @made-by-moonlight/athene-plugin-notifier-desktop@0.12.0
  - @made-by-moonlight/athene-plugin-notifier-discord@0.12.0
  - @made-by-moonlight/athene-plugin-notifier-openclaw@0.12.0
  - @made-by-moonlight/athene-plugin-notifier-slack@0.12.0
  - @made-by-moonlight/athene-plugin-notifier-webhook@0.12.0
  ...
  - @made-by-moonlight/athene-plugin-terminal-iterm2@0.12.0
  - @made-by-moonlight/athene-plugin-terminal-web@0.12.0
  - @made-by-moonlight/athene-plugin-tracker-github@0.12.0
  - @made-by-moonlight/athene-plugin-tracker-linear@0.12.0
  - @made-by-moonlight/athene-plugin-workspace-clone@0.12.0
...
- Updated dependencies [9b038ff]
  ...
  - @made-by-moonlight/athene-notifier-macos@0.11.3
  - @made-by-moonlight/athene-plugin-runtime-tmux@0.11.3
  - @made-by-moonlight/athene-plugin-runtime-process@0.11.3
  - @made-by-moonlight/athene-plugin-agent-claude-code@0.11.3
  - @made-by-moonlight/athene-plugin-agent-codex@0.11.3
  - @made-by-moonlight/athene-plugin-agent-aider@0.11.3
  - @made-by-moonlight/athene-plugin-agent-opencode@0.11.3
  - @made-by-moonlight/athene-plugin-agent-cursor@0.11.3
  - @made-by-moonlight/athene-plugin-agent-kimicode@0.11.3
  - @made-by-moonlight/athene-plugin-workspace-worktree@0.11.3
  - @made-by-moonlight/athene-plugin-workspace-clone@0.11.3
  - @made-by-moonlight/athene-plugin-tracker-github@0.11.3
  - @made-by-moonlight/athene-plugin-tracker-linear@0.11.3
  - @made-by-moonlight/athene-plugin-scm-github@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-desktop@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-slack@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-webhook@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-composio@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-dashboard@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-discord@0.11.3
  - @made-by-moonlight/athene-plugin-notifier-openclaw@0.11.3
  - @made-by-moonlight/athene-plugin-terminal-iterm2@0.11.3
  - @made-by-moonlight/athene-plugin-terminal-web@0.11.3
  - @made-by-moonlight/athene-web@0.11.3
  - @made-by-moonlight/athene-plugin-agent-grok@0.2.4
...
- Updated dependencies [22aef23]
  ...
  - @made-by-moonlight/athene-notifier-macos@0.11.2
  ...
  - @made-by-moonlight/athene-plugin-agent-aider@0.11.2
  ...
  - @made-by-moonlight/athene-plugin-workspace-clone@0.11.2
  ...
  - @made-by-moonlight/athene-plugin-notifier-desktop@0.11.2
  - @made-by-moonlight/athene-plugin-notifier-slack@0.11.2
  - @made-by-moonlight/athene-plugin-notifier-webhook@0.11.2
  - @made-by-moonlight/athene-plugin-notifier-composio@0.11.2
  - @made-by-moonlight/athene-plugin-notifier-dashboard@0.11.2
  - @made-by-moonlight/athene-plugin-notifier-discord@0.11.2
  - @made-by-moonlight/athene-plugin-notifier-openclaw@0.11.2
  - @made-by-moonlight/athene-plugin-terminal-iterm2@0.11.2
  - @made-by-moonlight/athene-plugin-terminal-web@0.11.2
  - @made-by-moonlight/athene-web@0.11.2
...
- Updated dependencies
  ...
  - @made-by-moonlight/athene-notifier-macos@0.11.0
  - @made-by-moonlight/athene-plugin-runtime-tmux@0.11.0
  - @made-by-moonlight/athene-plugin-runtime-process@0.11.0
  - @made-by-moonlight/athene-plugin-agent-claude-code@0.11.0
  - @made-by-moonlight/athene-plugin-agent-codex@0.11.0
  - @made-by-moonlight/athene-plugin-agent-aider@0.11.0
  - @made-by-moonlight/athene-plugin-agent-opencode@0.11.0
  - @made-by-moonlight/athene-plugin-agent-cursor@0.11.0
  - @made-by-moonlight/athene-plugin-agent-kimicode@0.11.0
  - @made-by-moonlight/athene-plugin-workspace-worktree@0.11.0
  - @made-by-moonlight/athene-plugin-workspace-clone@0.11.0
  - @made-by-moonlight/athene-plugin-tracker-github@0.11.0
  - @made-by-moonlight/athene-plugin-tracker-linear@0.11.0
  - @made-by-moonlight/athene-plugin-scm-github@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-desktop@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-slack@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-webhook@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-composio@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-dashboard@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-discord@0.11.0
  - @made-by-moonlight/athene-plugin-notifier-openclaw@0.11.0
  - @made-by-moonlight/athene-plugin-terminal-iterm2@0.11.0
  - @made-by-moonlight/athene-plugin-terminal-web@0.11.0
  - @made-by-moonlight/athene-web@0.11.0
  - @made-by-moonlight/athene-plugin-agent-grok@0.2.1
...
- 6d48022: Wire CLI activity events into `athene start`, `athene stop`, `athene spawn`, `athene update`, `athene setup`, `athene migrate-storage`, and shared CLI helpers. `athene events list --source cli` now answers RCA questions like "did AO start cleanly?", "was AO killed or did it crash?", and "did `athene spawn`/`athene stop` fail and why?". Adds `"cli"` to the `ActivityEventSource` union and 30+ event-emit sites covering startup, graceful and forced shutdown, restore, project resolution, config recovery, and migration paths.
- ecdf0c7: Add `AO_PUBLIC_URL` environment variable for users running AO behind a reverse proxy (remote dev containers, VPS deployments, internal tooling). When set, all user-facing dashboard URLs — `athene start` / `athene dashboard` console output, `athene open` browser launches, and `projectSessionUrl()` links surfaced to the orchestrator agent — use the public URL instead of `http://localhost:<port>`. Internal IPC (`daemon.ts` reload calls) still uses localhost since that traffic stays on the host.
...
- fcedb25: Wire activity events for the recovery subsystem, metadata-corruption detection, and agent-report apply path. New event kinds: `recovery.session_failed`, `recovery.action_failed`, `metadata.corrupt_detected`, `api.agent_report.session_not_found`, `api.agent_report.transition_rejected`. Adds `"recovery"` to the `ActivityEventSource` union. Lets RCA reconstruct `athene recover` invocations, find every silent metadata overwrite, and audit rejected agent transitions. Adds `athene events list --source` and `--kind` so these forensic event queries are available from the CLI.
...
- fe33bb7: Worker sessions now learn how to message the orchestrator that spawned them. When a project has an orchestrator running, the worker's system prompt gains a "Talking to the Orchestrator" section with the literal `athene send <prefix>-orchestrator "<message>"` command (rendered at prompt-build time, no env var, no shell-syntax variants). `athene send` itself now auto-prefixes outgoing messages with `[from $AO_SESSION_ID]` when invoked from inside an AO session, so the receiver always knows who's writing — symmetric across worker→orchestrator, orchestrator→worker, and worker→worker. Humans running `athene send` from a normal terminal stay unprefixed. (#1786)
...
- 3a69722: Remove the deprecated `ao init` command. Use `athene start` instead — it auto-creates the config on first run in an unconfigured repo.
...
- f330a1e: `athene session ls` and `athene status` now hide terminated sessions (`killed`, `terminated`, `done`, `merged`, `errored`, `cleanup`) by default. A dim footer reports how many were hidden and how to surface them. Pass `--include-terminated` to restore the previous unfiltered output.
  ...
  **Breaking — JSON output shape:** `athene session ls --json` and `athene status --json` now emit `{ data: [...], meta: { hiddenTerminatedCount: number } }` instead of a bare array. Scripts consuming the JSON must read `.data` for the session list. `--include-terminated` restores full data and reports `hiddenTerminatedCount: 0`.

  The existing `-a, --all` flag still only governs orchestrator visibility on `athene session ls` — it does **not** re-enable terminated sessions. Combine with `--include-terminated` when you want both.
...
- 2306078: Add SQLite-backed activity event logging for session and lifecycle diagnostics, plus `athene events` commands for listing, searching, and inspecting event log stats.
- f09cc72: `athene session ls` hides terminal sessions in text output by default; use `--include-terminated` for the full text list.
- e1bb51f: Fix restore behavior across AO session recovery flows.
  - restore the latest dead-but-restorable orchestrator on `athene start` instead of silently spawning a new orchestrator when tmux is gone
...
- f674422: Make project orchestrators deterministic and idempotent.
  ...
  - make `athene start`, the dashboard, and the orchestrator API reuse or restore the canonical session
