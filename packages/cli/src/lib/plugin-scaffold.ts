...
import type { PluginSlot } from "@made-by-moonlight/athene-core";
  ...
  return `${JSON.stringify(
    {
      ...
      dependencies: {
        "@made-by-moonlight/athene-core": CORE_VERSION_RANGE,
      },
      devDependencies: {
...
function buildIndexTs(input: PluginScaffoldInput): string {
  ...
  return `import type { PluginModule } from "@made-by-moonlight/athene-core";
