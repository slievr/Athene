...
import { resolveLocalPluginEntrypoint, type InstalledPluginConfig, type PluginSlot } from "@made-by-moonlight/core";
...
export const DEFAULT_REMOTE_MARKETPLACE_REGISTRY_URL =
  "https://raw.githubusercontent.com/slievr/Athene/main/packages/cli/src/assets/plugin-registry.json";
...
export { normalizeImportedPluginModule } from "@made-by-moonlight/core";
