...
function getSessionLoadErrorMessage(error: Error): string {
  ...
  if (normalized.includes("timed out"))
    return "The session request is taking too long. You can retry, or return to the orchestrator and reopen a different session.";
...
export default function OrchestratorSessionPage() {
  ...
  useEffect(() => {
    ...
    const mark = () => { pageUnloadingRef.current = true; };
  ...
  const fleetHref = orchestratorDashboardPath(orchestratorName);
      ...
      <div className="dashboard-main--desktop">
        <div className="flex h-full items-center justify-center">
          <ErrorDisplay
            ...
            tone="not-found"
            primaryAction={{ label: "Back to orchestrator", href: fleetHref }}
      ...
      <div className="dashboard-main--desktop">
        <div className="flex h-full items-center justify-center">
          <ErrorDisplay
            ...
            secondaryAction={{ label: "Back to orchestrator", href: fleetHref }}
            error={routeError}
            compact
            chrome="card"
          />
      ...
      <div className="dashboard-main--desktop">
        <div className="flex h-full items-center justify-center">
          <ErrorDisplay
            ...
            message="The backend has not returned this session yet. Retry once the terminal registers the session."
            tone="error"
