...
describe("AO orphan detection", () => {
  it("detects PPID=1 AO dashboard, websocket, and lifecycle processes", () => {
    const output = [
      ...
      "  90351      1 node /opt/homebrew/lib/node_modules/@made-by-moonlight/athene-web/dist-server/start-all.js",
      "  47457      1 node /opt/homebrew/lib/node_modules/@made-by-moonlight/athene-web@0.2.4/dist-server/start-all.js",
      "  47458      1 node @made-by-moonlight/athene-web@0.2.4 dist-server/start-all.js",
      "  47575      1 node /opt/homebrew/lib/node_modules/@made-by-moonlight/athene-web@0.2.4/dist-server/terminal-websocket.js",
      "  47580      1 node /opt/homebrew/lib/node_modules/@made-by-moonlight/athene-web@0.2.4/dist-server/direct-terminal-ws.js",
      "   9914      1 node /opt/homebrew/bin/athene lifecycle-worker codex-startup-factory",
      "  22222   3333 node /opt/homebrew/bin/athene lifecycle-worker not-an-orphan",
